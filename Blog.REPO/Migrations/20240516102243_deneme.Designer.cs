...
namespace Blog.REPO.Migrations
{
    ...
    [Migration("20240516102243_deneme")]
            ...
            modelBuilder.Entity("Blog.DATA.Concrete.Topic", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TopicId = 1,
                            CreateDate = new DateTime(2024, 5, 16, 13, 22, 43, 186, DateTimeKind.Local).AddTicks(8141),
                            Status = 0,
                            TopicName = "Bilimsel"
                        },
                        new
                        {
                            TopicId = 2,
                            CreateDate = new DateTime(2024, 5, 16, 13, 22, 43, 186, DateTimeKind.Local).AddTicks(8163),
                            Status = 0,
                            TopicName = "Tarihsel"
                        },
                        new
                        {
                            TopicId = 3,
                            CreateDate = new DateTime(2024, 5, 16, 13, 22, 43, 186, DateTimeKind.Local).AddTicks(8166),
                            Status = 0,
                            TopicName = "Finansal"
                        },
                        new
                        {
                            TopicId = 4,
                            CreateDate = new DateTime(2024, 5, 16, 13, 22, 43, 186, DateTimeKind.Local).AddTicks(8168),
                            Status = 0,
                            TopicName = "Evrimsel"
                        },
                        new
                        {
                            TopicId = 5,
                            CreateDate = new DateTime(2024, 5, 16, 13, 22, 43, 186, DateTimeKind.Local).AddTicks(8170),
                            Status = 0,
                            TopicName = "Siyasal"
                        });
                });
